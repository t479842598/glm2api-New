...
const GITHUB_REPO_URL = "https://github.com/t479842598/glm2api-manage"
...
export default function AppLayout() {
  ...
  const title =
    ...
    (location.pathname.startsWith("/admin/logs/") ? "日志详情" : "glm2api")
    ...
    >
      ...
      <aside className="hidden w-60 flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground md:flex">
        ...
        <div className="flex items-center gap-3 px-5 py-5">
          ...
          <div>
            <h1 className="text-sm font-semibold tracking-tight">glm2api</h1>
        ...
        <div className="grid grid-cols-6 gap-1">
          {navItems.map((item) => (
            <NavLink
              ...
              to={item.to}
              className={({ isActive }) =>
                `flex min-h-12 flex-col items-center justify-center gap-1 rounded-lg px-0.5 text-[10px] font-medium transition-colors ${
                  isActive
